...
class AuthenWithBE {
	async generateOAuthURL(context) {
		...
		const grantAccessUrl = `https://auth.atlassian.com/authorize?audience=api.atlassian.com&client_id=wDzzxAZSrrM9DtPwZ295BMT3YoFR6KeD&scope=manage%3Ajira-project%20write%3Ajira-work%20read%3Ajira-work&redirect_uri=http%3A%2F%2Flocalhost%3A5126%2FAuthentication%2FCallback&state=${stateData}&response_type=code&prompt=consent`;
